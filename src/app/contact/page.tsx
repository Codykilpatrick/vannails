              ...
              <div className="bg-white rounded-2xl p-8 shadow-md space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+15407642843" className="text-primary hover:text-primary-dark transition-colors">
                      (540) 764-2843
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-dark/60">15315 Montanus Dr<br />Culpeper, VA 22701</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-dark/60 text-sm space-y-1">
